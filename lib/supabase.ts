...
const supabaseUrl = 'https://keqaosmbblccidztklaj.supabase.co'
const supabaseAnonKey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImtlcWFvc21iYmxjY2lkenRrbGFqIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjM1MjM1MDgsImV4cCI6MjA3OTA5OTUwOH0.-NbSjP4nHKp9D8xB5LAjnWkxefGBzTAecrnXi1vzgF0'
...
export async function saveOrder(orderData: any, customerData: any) {
  try {
    const order: Omit<Order, 'id' | 'created_at'> = {
      ...
      is_bundle: orderData.bundle,
      email_discount: orderData.emailDiscount,
      upsell_discount: orderData.upsellDiscount,
      took_big_offer: orderData.tookBigOffer,
      oto_offer: orderData.oto,
      oto_price: orderData.otoPrice,
